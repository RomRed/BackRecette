...
public class IngredientRecette {
    ...
    private IngredientDetail idIngredientDetails;
    ...
    public IngredientDetail getIdIngredientDetails() {
        return idIngredientDetails;
    }

    public void setIdIngredientDetails(IngredientDetail idIngredientDetails) {
